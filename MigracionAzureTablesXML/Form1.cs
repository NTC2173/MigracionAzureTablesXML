...
namespace MigracionAzureTablesXML
{
    public partial class Form1 : Form
    {
        ...
        private async void botonMigrar_Click(object sender, EventArgs e)
        {
            ...
            //connectionString = "DefaultEndpointsProtocol=https;AccountName=storageign;AccountKey=lszVsQdAxKSRJXIFPM29HPxYZC5DtKGW2vcBODnQbl11LZmoxAUot/b+2GxGx339FIGna6hw0GNv+ASt5+UASQ==;EndpointSuffix=core.windows.net";
